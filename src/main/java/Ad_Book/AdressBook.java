...
public class AdressBook {
	...
	ArrayList<PersonContact> contactBook = new ArrayList<>();
	...
	public void sortByFirstName() {
		ArrayList<PersonContact>  sortedList = (ArrayList<PersonContact>) contactBook.stream().sorted((type1, type2) -> (type1.getFirstName().compareTo(type2.getFirstName()))).collect(Collectors.toList());
		for (PersonContact contact : sortedList) {
			System.out.println("Name: " + contact.getFirstName()+ "  " + contact.getLastName());
		}
	}
	public void sortByCity() {
		ArrayList<PersonContact>  sortedList = (ArrayList<PersonContact>) contactBook.stream().sorted((type1, type2) -> (type1.getCity().compareTo(type2.getCity()))).collect(Collectors.toList());
		for (PersonContact contact : sortedList) {
			System.out.println("Name: " + contact.getFirstName()+ "  " + contact.getLastName());
			System.out.println("City: " + contact.getCity());
			System.out.println("\n");
	...
	public void sortByState() {
		ArrayList<PersonContact>  sortedList = (ArrayList<PersonContact>) contactBook.stream().sorted((type1, type2) -> (type1.getState().compareTo(type2.getState()))).collect(Collectors.toList());
		for (PersonContact contact : sortedList) {
			System.out.println("Name: " + contact.getFirstName()+ "  " + contact.getLastName());
			System.out.println("State: " +contact.getState());
			System.out.println("\n");
	...
	public void sortByZip() {
		ArrayList<PersonContact>  sortedList = (ArrayList<PersonContact>) contactBook.stream().sorted((type1, type2) -> (int)(type1.getZip() - type2.getZip())).collect(Collectors.toList());
		for (PersonContact contact : sortedList) {
			System.out.println("Name: " + contact.getFirstName()+ "  " + contact.getLastName());
